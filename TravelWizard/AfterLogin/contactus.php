...
// Function to escape user input and prevent XSS attacks by converting special characters
...
if (isset($_POST['submit'])) {
    try {
        ...
        if (!empty($ticket_data['email']) && !empty($ticket_data['subject']) && !empty($ticket_data['message'])) {
            // Create SQL insert statement using named placeholders
            $sql = sprintf(
            ...
            // Prepare and execute the SQL statement using 
